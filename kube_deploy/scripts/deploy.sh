...
# keystone-setup post-install Job never need a registry pull during the 15-min
# Helm timeout window.  Without this the image pull consumes several minutes
# before the Job even starts, causing a context deadline exceeded.
