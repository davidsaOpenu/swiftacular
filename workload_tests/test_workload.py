...
LARGE_MEAN_SIZE = int(1.1 * 1024 * 1024 * 1024) # 1.1 GB
LARGE_MAX_SIZE = int(1.1 * 1024 * 1024 * 1024) # 1.1 GB
LARGE_MIN_SIZE = int(1.1 * 1024 * 1024 * 1024) # 1.1 GB
LARGE_STDEV_SIZE = 0
...
def test_large_object_workload(connection, container):
    run_workload_test(LARGE_MEAN_SIZE, LARGE_MAX_SIZE, LARGE_MIN_SIZE, LARGE_STDEV_SIZE,
