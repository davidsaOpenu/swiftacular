...
class BaseDiskFile(object):
    ...
    def open(self, modernize=False, current_time=None):
        ...
        # BlueStore Backend: Log object open
        if hasattr(self, "_account") and hasattr(self, "_container") and hasattr(self, "_obj"):
            self.manager.logger.info(
                "[BLUESTORE] Opening object: account=%s container=%s obj=%s",
                self._account, self._container, self._obj)
